...
void ff_weight_h264_pixels_16_neon_10(uint8_t *dst, ptrdiff_t stride, int height,
                                      int log2_den, int weight, int offset);
void ff_weight_h264_pixels_8_neon_10(uint8_t *dst, ptrdiff_t stride, int height,
                                     int log2_den, int weight, int offset);
void ff_weight_h264_pixels_4_neon_10(uint8_t *dst, ptrdiff_t stride, int height,
                                     int log2_den, int weight, int offset);

void ff_biweight_h264_pixels_16_neon_10(uint8_t *dst, uint8_t *src, ptrdiff_t stride,
                                        int height, int log2_den, int weightd,
                                        int weights, int offset);
void ff_biweight_h264_pixels_8_neon_10(uint8_t *dst, uint8_t *src, ptrdiff_t stride,
                                       int height, int log2_den, int weightd,
                                       int weights, int offset);
void ff_biweight_h264_pixels_4_neon_10(uint8_t *dst, uint8_t *src, ptrdiff_t stride,
                                       int height, int log2_den, int weightd,
                                       int weights, int offset);
